          ...
          {/* Login button */}
          {
              ...
              <div className='flex-relative'>
                <button onClick={()=>(setDropdownStatus(!dropdownStatus))} className='px-2 py-1 border-3 rounded-lg flex gap-3 items-center'>
                  <img src={profilePicture?profilePicture.startsWith("https://lh3.googleusercontent.com/a/ACg8ocLGhkZNxXy-6mMKcTJ_3jV38DQScdCho7cQ1ccRm8iBIzCvuQ=s96-c")?profilePicture:`${base_url}/uploadImg/${profilePicture}`:"https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG-Image.png"} alt="profilelogo"
                   width={'40px'}/>
                   {username}
                </button>
                {
                  dropdownStatus &&
                  <ul className='border text-sm absolute right-0 z-10 rounded-md bg-white bg-white-bottom-15'>

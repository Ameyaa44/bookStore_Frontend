                ...
                <>
                  {
                    ...
                    <div className=' shadow-lg py-3 px-2 md:grid grid-cols-7 mb-4'>
                      ...
                      <div className='px-10'>
                        <button className='bg-blue-800 text-white px-3 py-3 rounded-sm flex items-center' 
                  ...
                  <div style={{width: "500px" }} className="bg-white rounded-2xl ">
                    ...
                    <div className="p-5">
                      ...
                      <div className='my-3'>
                        ...
                        <input type="file"  ref={fileInputRef} name='' id='' onChange={(e)=>{setCareerData({...careerData,resume:e.target.files[0]})}} className='border w-full border-gray-500 cursor-pointer file:bg-gray-400 file:p-1 cursor-pointer'/>
                      </div>
                    </div>
                    <div className="bg-gray p-3 flex justify-end gap-2 rounded-b-2xl">
                      ...
                      <button className="p-2 border rounded-sm bg-green-700 text-white hover:bg-white hover:border-green-600 hover:text-green-500" onClick={handleApplyJob}>Submit</button>
                    </div>
                  </div>
                </div>
              </div>

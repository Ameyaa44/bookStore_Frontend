...
const handleLogin=async()=>{
  ...
  return (
    <>
      <div className='w-screen min-h-screen bg-[url(/login-bg.jpeg)]  bg-cover flex flex-col items-center px-5 py-10'>
        {/* <h1 className='text-center text-4xl font-bold text-white'>BOOK STORE</h1> */}
        <div className='w-full max-w-md py-4 px-4 bg-gray-900 mt-5 flex flex-col text-white items-center rounded-lg shadow-lg'>
         <FaRegUserCircle className='text-7xl text-white my-5'/>
          ...
          <div className='w-full my-9 px-20'>
            ...
            <div className='flex justify-between text-sm'>
              <span className='text-yellow-600 mt-2' style={{fontSize:'12px'}}>*Never Share Your password With Others</span>
              {
                !register &&
            ...
            {
              register?
                <button onClick={handleRegister} className='w-full bg-blue-800 py-2 rounded-sm font-semibold mt-4'>Register</button>
                :
                <>
                <button onClick={handleLogin} className='w-full bg-green-600 py-2 rounded-sm font-semibold mt-4'>login</button>
                <div className='my-5 flex items-center justify-center gap-2 text-xs sm:text-sm'>
                  <span className='border-t w-10 sm:w-20'></span>
                  <span>OR</span>
                  <span className='border-t w-10 sm:w-20'></span>
                </div>
